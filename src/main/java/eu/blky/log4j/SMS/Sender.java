...
public class Sender implements Runnable  {
  ...
  // ++ huawei E1823 Manufacturer: huawei Model: E1823 Revision: 11.825.03.10.55 IMEI: 357509030197304 +GCAP: +CGSM,+DS,+ES (COM5)
  private SerialParameters defaultParameters=initDef();
  static	int databits =8;
  static	int parity=0;
  static	int baudRate=115200;
  static	int flowControlOut=0;
  static	String portName="COM20";
  static	int flowControlIn=0;
  static	int stopbits=1;

  SerialParameters  initDef(){
	//"COM20",115200,0,0,8,1,0);
	  return  new SerialParameters(portName, baudRate, flowControlIn, flowControlOut, databits, stopbits, parity); 
